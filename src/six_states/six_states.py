...
from six_states.six_states_algorithm import SixStatesAlgorithm
import time
...
## Main class of Six-States Simulator
## @see https://qiskit.org/textbook/ch-algorithms/quantum-key-distribution.html
class SixStates:
  ## Constructor
  def __init__(self, token):
    ## The implemented protocol
    self.six_state_algorithm = SixStatesAlgorithm()
  ...
  def __show_header(self):
    print('\n' + SIX_STATES_SIMULATOR + '\n' + '=' * len(SIX_STATES_SIMULATOR) + '\n')
    print('A Six-States simulator using Qiskit')
    print('WARNING: The Six-State simulator uses your personal IBM Quantum Experience')
  ...
  def __show_options(self):
    ...
    print('\n' + SIX_STATES_SIMULATOR + guest_mode_string)
    print('=' * (len(SIX_STATES_SIMULATOR) + len_guest_mode_string) + '\n')
  ...
  ## Run Six-States simulation once
  def __run_simulation(self):
    ...
    halo_text = 'Running Six-States simulation in ' + execution_description
    ...
    try:
      ...
      halo.succeed()
      print('  Six-States simulation runned in', str(time_ms), 'ms')
    except Exception as exception:
      halo.fail()
      print('Exception:', exception)

  ## Run an experiment of Six-States simulation
